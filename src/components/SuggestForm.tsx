    ...
    return (
      <div className="tz-chamfer bg-white p-8 text-center tz-card ring-1 ring-stone-200/60">
        ...
        <Link
          ...
          className="tz-btn mt-6 inline-flex bg-linear-to-b from-stone-800 to-stone-950 px-6 py-3 text-xs tracking-wider text-white uppercase"
        >
    ...
    <form action={action} className="space-y-7">
      ...
      <div className="flex flex-wrap items-center gap-4">
        <button
          type="submit"
          disabled={pending}
          className="tz-btn bg-linear-to-b from-stone-800 to-stone-950 px-8 py-3 text-xs tracking-wider text-white uppercase disabled:opacity-40"
        >
